...
a2enmod actions fcgid alias proxy_fcgi rewrite headers proxy proxy_http deflate expires
...
sed -i "s/^max_file_uploads = .*/max_file_uploads = 20/" /etc/php/8.0/fpm/php.ini
sed -i "s/^allow_url_fopen = .*/allow_url_fopen = On/" /etc/php/8.0/fpm/php.ini
sed -i "s/^short_open_tag = .*/short_open_tag = Off/" /etc/php/8.0/fpm/php.ini
sed -i "s/^error_reporting = .*/error_reporting = E_ALL & ~E_DEPRECATED & ~E_STRICT/" /etc/php/8.0/fpm/php.ini
sed -i "s/^display_errors = .*/display_errors = Off/" /etc/php/8.0/fpm/php.ini
sed -i "s/^display_startup_errors = .*/display_startup_errors = Off/" /etc/php/8.0/fpm/php.ini
sed -i "s/^log_errors = .*/log_errors = On/" /etc/php/8.0/fpm/php.ini
sed -i "s/^log_errors_max_len = .*/log_errors_max_len = 1024/" /etc/php/8.0/fpm/php.ini
sed -i "s/^ignore_repeated_errors = .*/ignore_repeated_errors = Off/" /etc/php/8.0/fpm/php.ini
sed -i "s/^ignore_repeated_source = .*/ignore_repeated_source = Off/" /etc/php/8.0/fpm/php.ini
sed -i "s/^html_errors = .*/html_errors = On/" /etc/php/8.0/fpm/php.ini
sed -i "s/^realpath_cache_size = .*/realpath_cache_size = 4096K/" /etc/php/8.0/fpm/php.ini
sed -i "s/^realpath_cache_ttl = .*/realpath_cache_ttl = 120/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.enable=0/opcache.enable=1/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.memory_consumption=128/opcache.memory_consumption=256/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.interned_strings_buffer=8/opcache.interned_strings_buffer=16/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.max_accelerated_files=10000/opcache.max_accelerated_files=20000/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.revalidate_freq=2/opcache.revalidate_freq=0/" /etc/php/8.0/fpm/php.ini
sed -i "s/^opcache.save_comments=1/opcache.save_comments=0/" /etc/php/8.0/fpm/php.ini
